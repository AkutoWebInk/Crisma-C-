...
#include "../../src/Widgets/ItemCard/ItemCard.h"
...
namespace {
struct qt_meta_tag_ZN8ItemCardE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8ItemCardE = QtMocHelpers::stringData(
    "ItemCard"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8ItemCardE[] = {
...
Q_CONSTINIT const QMetaObject ItemCard::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8ItemCardE.offsetsAndSizes,
    qt_meta_data_ZN8ItemCardE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8ItemCardE_t,
        // Q_OBJECT / Q_GADGET
...
void *ItemCard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8ItemCardE.stringdata0))
